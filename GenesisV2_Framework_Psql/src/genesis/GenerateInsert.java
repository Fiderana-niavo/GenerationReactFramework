...
public class GenerateInsert {
    ...
    public String generateImportInsertEntite(String nomtable, String importInsertEntite) {
        return importInsertEntite.replace("[nomTableMaj]", HandyManUtils.majStart(nomtable));
    }
    ...
    public  String generateInsertView(Entity e,String select,String input,String tempformDataAttribute,String tempimportForeign,String tempforeignList,String templateInsert,String importInsertEntite){
        ...
        String foreignList="";
        String temp="";
        String insert=generateImportInsertEntite(e.getTableName(),importInsertEntite);
