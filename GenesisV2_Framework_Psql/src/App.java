...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        String path = "D:/S5/GenesisV2_Framework_Psql/src/ViewUpdate";
        String servicePath = "D:/S5/GenesisV2_Framework_Psql/src/Service";
        String ApiPath = "D:/S5/GenesisV2_Framework_Psql/src/API";
        try(Scanner scanner=new Scanner(System.in)){
            ...
            try(Connection connect=database.getConnexion(credentials)){
                ...
                for(int i=0;i<models.length;i++){
                    ...
                    views[i] = language.createComposant(entities[i],projectName);
                    views[i] = language.createPage(entities[i],projectName);
