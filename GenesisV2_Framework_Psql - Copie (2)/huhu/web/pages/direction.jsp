...
<%
    Direction[] liste=(Direction[])request.getAttribute("o");
...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6 offset-3">
            <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4">Liste de direction</h6>
                <table class="table">
                    <thead>
                        <tr>                            
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/Huhu/updatedirection.do" method="put">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="modifiermodalLabel">Modifier un direction</h1>
    ...
    <input type="text" class="form-control" id="nominput" aria-describedby="nomhelp" name="nom" value="<%= o.getNom() %>"> 
                                ...
                                <td><form action="/Huhu/deletedirection.do" method="delete">
                                    <input type="hidden" name="id" value="<%= o.getId() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/Huhu/insertdirection.do" method="post">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="ajoutmodalLabel">Ajouter un direction</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3"> 
