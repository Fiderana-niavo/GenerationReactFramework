...
<%
    Etu[] liste=(Etu[])request.getAttribute("o");
    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6 offset-3">
            <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4">Liste de etu</h6>
                <table class="table">
                    <thead>
                        <tr>                            
                            <th scope="col">Id</th><th scope="col">Mlle</th><th scope="col">Nom</th>
                        </tr>
                    <tbody>
                        <% for(Etu o:liste){ %>
                            <tr>
                                <td><%= o.getId() %></td><td><%= o.getMlle() %></td><td><%= o.getNom() %></td>
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/Huhu/updateetu.do" method="put">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="modifiermodalLabel">Modifier un etu</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <input type="hidden" name="id" value="<%= o.getId() %>">
                                            <div class="mb-3"> 
    <label for="mlleinput" class="form-label">Mlle
    </label> 
    <input type="number" step="1.0" class="form-control" id="mlleinput" name="mlle" value="<%= o.getMlle() %>"> 
</div>
<div class="mb-3"> 
    ...
    <input type="text" class="form-control" id="nominput" aria-describedby="nomhelp" name="nom" value="<%= o.getNom() %>"> 
                                ...
                                <td><form action="/Huhu/deleteetu.do" method="delete">
                                    <input type="hidden" name="id" value="<%= o.getId() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/Huhu/insertetu.do" method="post">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="ajoutmodalLabel">Ajouter un etu</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3"> 
    ...
    <input type="number" step="1.0" class="form-control" id="mlleinput" name="mlle"> 
</div>
<div class="mb-3"> 
    <label for="nominput" class="form-label">Nom
    </label> 
