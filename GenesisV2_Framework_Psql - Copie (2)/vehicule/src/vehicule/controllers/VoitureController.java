...
import vehicule.entities.Voiture;
...
public ModelRedirect insert(ServletEntity entity) throws Exception{
    ...
    o.setMarque(new vehicule.entities.Marque(Integer.parseInt(entity.getData().get("marque"))));o.setNomvoiture(entity.getData().get("nomvoiture"));o.setDatasortie(java.time.LocalDate.parse(entity.getData().get("datasortie")));
...
public ModelView crudpage(ServletEntity entity) throws Exception{
    try(Connection connex=DAOConnexion.getConnexion("org.postgresql.Driver", "postgresql", "localhost", "5432", "vehiculegeneration", "postgres", "p", false, false)){
        ...
        model.addItem("o", o);
        vehicule.entities.Marque[] marque=dao.select(connex, vehicule.entities.Marque.class);
